...
def create_split_list(imgpath, train_percent, test_percent, val_percent):
    ...
    for imgname in imglist:
        if imgname not in val_imglist and imgname not in test_imglist:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_percent', type=int, default=0, help='Percentage of test set')
    parser.add_argument('--val_percent', type=int, default=20, help='Percentage of val set')
